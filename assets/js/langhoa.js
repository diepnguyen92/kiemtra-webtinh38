...
input500K.addEventListener("change",(event)=>{
  ...
  if(isChecked){
    const listData500k = fillterByPrice(data, 0, 500000, "Lang hoa")
...
input1Mil.addEventListener("change",(event)=>{
  ...
  // console.log(isChecked);
  if(isChecked){
    const listData1Mil = fillterByPrice(data, 500000, 1000000, "Lang hoa")
...
inputUp1mil.addEventListener("change",(event)=>{
  ...
  // console.log(isChecked);
  if(isChecked){
    const listDataUp1Mil = fillterByPrice(data, 1000000, 2000000, "Lang hoa")
...
inputUp2mil.addEventListener("change",(event)=>{
  ...
  // console.log(isChecked);
  if(isChecked){
    const listDataUp2Mil = fillterByPrice(data, 2000000, 200000000, "Lang hoa")
