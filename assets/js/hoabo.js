...
input500K.addEventListener("change",(event)=>{
  ...
  if(isChecked){
    const listData500k = fillterByPrice(data, 0, 500000, "Hoa bo")
    rowJsHkt.innerHTML = renderData(listData500k)
  }
  else {rowJsHkt.innerHTML = renderData(listDataHkt)}
})
// khoảng giá  500k -1tr
input1Mil.addEventListener("change",(event)=>{
  ...
  // console.log(isChecked);
  if(isChecked){
    const listData1Mil = fillterByPrice(data, 500000, 1000000, "Hoa bo")
    rowJsHkt.innerHTML = renderData(listData1Mil)
  }
  else {rowJsHkt.innerHTML = renderData(listDataHkt)}
})
// khoảng giá  1tr -2tr
inputUp1mil.addEventListener("change",(event)=>{
  ...
  // console.log(isChecked);
  if(isChecked){
    const listDataUp1Mil = fillterByPrice(data, 1000000, 2000000, "Hoa bo")
    rowJsHkt.innerHTML = renderData(listDataUp1Mil)
  }
  else {rowJsHkt.innerHTML = renderData(listDataHkt)}
})
// khoảng giá  >2tr
inputUp2mil.addEventListener("change",(event)=>{
  ...
  // console.log(isChecked);
  if(isChecked){
    const listDataUp2Mil = fillterByPrice(data, 2000000, 200000000, "Hoa bo")
    rowJsHkt.innerHTML = renderData(listDataUp2Mil)
  }
  else {rowJsHkt.innerHTML = renderData(listDataHkt)}
})
...
customSelect.addEventListener('change',(event)=>{
  ...
  sortData = sortByData(data,'descending')}
    ...
    sortData = listDataHkt}
    else {
      sortData= listDataHkt
    }
rowJsHkt.innerHTML = renderData(sortData);
  });